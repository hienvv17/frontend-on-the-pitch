        ...
        <Container maxWidth="lg" sx={{ px: 3 }}>
          ...
          >
            ...
            <Typography variant="h6" sx={{ maxWidth: 700, mx: 'auto' }}>
              Chào mừng bạn đến với dịch vụ thuê sân thể thao của chúng tôi – nơi mang đến giải pháp
              tối ưu và tiện lợi cho nhu cầu vui chơi và luyện tập thể thao của bạn.
            </Typography>
          </Box>
          {/* Mission Section */}
            ...
            <Grid item xs={12} md={7} sx={{ display: 'flex' }}>
              ...
              >
                ...
                <Typography variant="body1" color="text.primary" sx={{ pl: 1 }}>
                  Chúng tôi hướng đến mục tiêu tạo ra nền tảng đặt sân thể thao trực tuyến dễ sử
                  dụng, giúp người chơi tìm kiếm và thuê sân nhanh chóng, thuận tiện mọi lúc mọi
                  nơi.
                </Typography>
              </Paper>
            </Grid>
            ...
            <Grid item xs={12} md={6} sx={{ display: 'flex' }}>
              ...
              >
                ...
                <Typography variant="body1" paragraph sx={{ pl: 1 }}>
                  Chúng tôi luôn nỗ lực cải tiến dịch vụ, lắng nghe ý kiến khách hàng để mang đến
                  trải nghiệm tốt nhất, giúp bạn tận hưởng những khoảnh khắc thể thao vui khỏe trọn
                  vẹn.
                </Typography>
              </Paper>
            </Grid>
