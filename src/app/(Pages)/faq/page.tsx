...
const faqItems = [
    ...
    },
    {
        ...
        answer: 'Chúng tôi chấp nhận thanh toán bằng chuyển khoản ngân hàng và thanh toán qua ví điện tử.'
    },
    {
        question: 'Tôi đã đặt sân, bây giờ tôi muốn hủy',
        answer: 'Bạn có thể hủy đặt sân trước ít nhất 48 giờ để được hoàn tiền. Hủy sau thời gian đó sẽ không được hoàn tiền.'
    },
    {
        question: 'Sân có cung cấp dụng cụ thể thao không?',
        answer: 'Một số sân có cung cấp dụng cụ thể thao, bạn vui lòng kiểm tra thông tin chi tiết trên trang đặt sân của từng sân.'
    },
    {
        question: 'Tôi có thể đặt sân cho nhóm lớn không?',
        answer: 'Có, bạn có thể liên hệ với chúng tôi để được tư vấn và đặt sân phù hợp với số lượng người chơi trong nhóm của bạn.'
    },
    {
