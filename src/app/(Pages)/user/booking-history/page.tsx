...
import { Container, Grid2 as Grid, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, Typography } from '@mui/material';
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Typography variant='h5' color="var(--Primary-500)"
                                        sx={{ fontWeight: 'bold' }}
                                    >Lịch sử đặt sân</Typography>
                                </Grid>
                            </Grid>
                                        ...
                                        <Table stickyHeader aria-label="simple table" >
                                            <TableHead sx={{ backgroundColor: '#F4F6F8' }}>
                                                <TableRow sx={classes.tableRow}>
                                                    ...
                                                    <TableCell sx={{ ...classes.tableHeader }} colSpan={3}>Trạng thái</TableCell>
                                                </TableRow>
                                            </TableHead>
                                                    ...
                                                    history.length > 0
                                                        ...
                                                        history.map((index) => (
                                                            <TableRow key={index} hover sx={{ ...classes.tableRow }}>
                                                                ...
                                                                <TableCell sx={{ ...classes.tableCell, textAlign: 'center' }} colSpan={3}>status</TableCell>
                                                            </TableRow>
                                                        ))
                                                        :
