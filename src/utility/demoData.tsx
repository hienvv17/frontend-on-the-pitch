...
export const stadiumList = {
    ...
    fields: [
      {
        id: 1,
        name: 'Sân Q10-1',
        image: 'https://res.cloudinary.com/dv8qmimg8/image/upload/v1743151739/image_12_ub4gfu.png',
        location: 'Quận 10',
        price: '250.000 VND/h',
        rating: 4.5,
      },
      ...
      },
      {
        id: 4,
        name: 'Sân Q7-1',
        image: 'https://res.cloudinary.com/dv8qmimg8/image/upload/v1743151740/image_11_zmvwsc.png',
        location: 'Quận 7',
        price: '220.000 VND/h',
        rating: 4.0,
      },
  ...
  tennis: {
    ...
    fields: [
      {
        name: 'Sân ABC',
        image: 'https://res.cloudinary.com/dv8qmimg8/image/upload/v1743151742/tennis_01_revj66.png',
        location: 'Quận 10',
        price: '250.000 VND/h',
        rating: 4.5,
      },
      {
        name: 'Sân XYZ',
        image: 'https://res.cloudinary.com/dv8qmimg8/image/upload/v1743151742/tennis_02_obcdvd.png',
        location: 'Quận 7',
        price: '220.000 VND/h',
        rating: 4.0,
      },
      {
        name: 'Sân XYZ',
        image: 'https://res.cloudinary.com/dv8qmimg8/image/upload/v1743151742/tennis_03_pkhufu.png',
        location: 'Quận 9',
        price: '220.000 VND/h',
        rating: 4.6,
      },
      {
        name: 'Sân XYZ',
        image: 'https://res.cloudinary.com/dv8qmimg8/image/upload/v1743151742/tennis_04_rjjzxt.png',
        location: 'Quận 2',
        price: '220.000 VND/h',
        rating: 5.0,
      },
